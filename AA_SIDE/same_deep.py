...
OUTPUT_FILE = "/projects/0/prjs1482/UvA/Outputs/Side/deepseek_speakeronly_SAME.json"
...
if __name__ == "__main__":
    ...
    for folder in all_folders:
        ...
        # All four images are the target image
        image_set_paths = [target_img_path] * NUM_IMAGES
